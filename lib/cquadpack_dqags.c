...
/* First approximation to the integral. */
    ierro = 0;
    result = cquadpack_G_K21(f,a,b,abserr,&defabs,&resabs, user_data);
...
/* Bisect the interval with the nrmax-th largest error estimate. */
        ...
        b2 = blist[maxerr];
        erlast = errmax;
        area1 = cquadpack_G_K21(f,a1,b1,&error1,&resabs,&defab1, user_data);
        area2 = cquadpack_G_K21(f,a2,b2,&error2,&resabs,&defab2, user_data);
